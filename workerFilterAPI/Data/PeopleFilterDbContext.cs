...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        //=> optionsBuilder.UseSqlServer("Server=.;Database= peopleFilterDB; TrustServerCertificate=True; Trusted_Connection=True;");
            => optionsBuilder.UseSqlServer("Server=tcp:sqlserver-workerfilter-westeu-dev-001.database.windows.net,1433;Initial Catalog=sqldb-workerfilter-westeu-dev-001;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;Authentication=\"Active Directory Default\";");
